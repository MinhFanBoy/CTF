...
print(xx)
s = var('s')
bounds = {x: _sage_const_2 **(_sage_const_72  - _sage_const_100 .nbits()) for x in xx}
print(f"{bounds = }")
print(_sage_const_100 .nbits())
bounds[s] = p
print(bounds)
equations = []
for i, x in enumerate(xx):
    s = s * a + b
    equations.append((s == _sage_const_100 *x + out[i], p))
# print(equations)
