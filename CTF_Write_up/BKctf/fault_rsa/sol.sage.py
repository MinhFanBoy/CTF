...
_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_0p5 = RealNumber('0.5'); _sage_const_8 = Integer(8); _sage_const_2 = Integer(2); _sage_const_5 = Integer(5); _sage_const_1000 = Integer(1000); _sage_const_150 = Integer(150); _sage_const_575032372235516650432 = Integer(575032372235516650432); _sage_const_1094555114006097458981 = Integer(1094555114006097458981); _sage_const_65537 = Integer(65537); _sage_const_3367854845750390371489 = Integer(3367854845750390371489); _sage_const_49450786403 = Integer(49450786403); _sage_const_68105182763 = Integer(68105182763); _sage_const_256 = Integer(256); _sage_const_6 = Integer(6)
...
m = _sage_const_575032372235516650432 

c = _sage_const_1094555114006097458981 
e = _sage_const_65537 
n = _sage_const_3367854845750390371489 

p = _sage_const_49450786403 
q = _sage_const_68105182763 

know = bytes_to_long(b"BKSEC{\x00\x00\x00\x00\x00\x00\x00\x00\x00}")

PR = PolynomialRing(Zmod(n), names=('x',)); (x,) = PR._first_ngens(1)

f = know + _sage_const_256  * x - m

roots = coppersmith(f, bounds = (_sage_const_2 ), m = _sage_const_6 )
print(roots)
